...
func (storage *UserProfileStorage) Get(key int64) (object *UserProfile, err error) {
    return storage.Data[key], nil
}

func (storage *UserProfileStorage) Set(key int64, object *UserProfile) (err error) {
    storage.Data[key] = object
    return nil
}

func (storage *UserProfileStorage) Delete(key int64) (err error) {
...
func NewUserProfileStorage() *UserProfileStorage {
    return &UserProfileStorage{Data: make(map[int64]*UserProfile)}
}
