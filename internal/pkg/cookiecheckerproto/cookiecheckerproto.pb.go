...
// source: cookiecheckerproto.proto

package cookiecheckerproto
...
func (*CookieRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cookiecheckerproto_26cebc6427e1b263, []int{0}
}
...
type CookieResponse struct {
	Data                 *JwtData `protobuf:"bytes,1,opt,name=Data,proto3" json:"Data,omitempty"`
...
func (*CookieResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cookiecheckerproto_26cebc6427e1b263, []int{1}
}
...
func (m *CookieResponse) GetData() *JwtData {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *CookieResponse) GetError() string {
	if m != nil {
		return m.Error
	}
	return ""
...
func (*JwtData) Descriptor() ([]byte, []int) {
	return fileDescriptor_cookiecheckerproto_26cebc6427e1b263, []int{2}
}
...
func (dst *JwtData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_JwtData.Merge(dst, src)
}
...
func (m *JwtData) GetEmail() string {
	if m != nil {
		return m.Email
	}
	return ""
...
func (m *JwtData) GetUsername() string {
	if m != nil {
		return m.Username
	}
	return ""
...
var _CookieChecker_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "cookiecheckerproto.proto",
}

func init() {
	proto.RegisterFile("cookiecheckerproto.proto", fileDescriptor_cookiecheckerproto_26cebc6427e1b263)
}

var fileDescriptor_cookiecheckerproto_26cebc6427e1b263 = []byte{
	// 219 bytes of a gzipped FileDescriptorProto
	,
}
